...
def powerball():
    print ("Today's numbers are "+str(random.randint(0,60))+","+str(random.randint(0,60))+","+str(random.randint(0,60))+","+str(random.randint(0,60))+" and "+str(random.randint(0,60))+"."+" The Powerball number is "+str(random.randint(0,36)))
